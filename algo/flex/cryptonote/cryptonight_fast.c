...
static void do_fast_groestl_hash(const void* input, size_t len, char* output) {
...
struct flex_cryptonightfast_ctx {
...
void flex_cryptonightfast_fast_hash(const char* input, char* output, uint32_t len) {
